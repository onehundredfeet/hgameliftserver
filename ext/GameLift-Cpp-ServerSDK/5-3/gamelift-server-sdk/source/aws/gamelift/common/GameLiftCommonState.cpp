...
Internal::GetInstanceOutcome Internal::GameLiftCommonState::GetInstance() {
    if (!m_instance) {
...
Internal::GetInstanceOutcome Internal::GameLiftCommonState::GetInstance(Internal::GAMELIFT_INTERNAL_STATE_TYPE stateType) {
    if (!m_instance) {
        return Internal::GetInstanceOutcome(GameLiftError(GAMELIFT_ERROR_TYPE::NOT_INITIALIZED));
    }
